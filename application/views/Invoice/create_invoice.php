...
<html>
    ...
    <body>
        ...
        <form action="" form method="post" action="<?= base_url('Invoice/add') ?>">
            ...
            <table>
                <tr><td>NO. PkS</td><td><input type="text" name="nopks"onkeyup="isi_otomatis()" id="NOPKS"></td></tr>
                <tr><td>Kode Termin</td><td><input type="text" name="KODE_TERMIN" id="kodetermin" readonly></td></tr>
                <tr><td>Termin ke</td><td><input type="text" id="termin"readonly></td></tr>
                <tr><td>Nominal</td><td><input type="text" id="nominal" readonly></td></tr>
                <tr><td>Invoice</td><td><input type="text" name="INVOICE"></td></tr>
                <tr><td>Tanggal</td><td><input type="date" name="TGL_INVOICE"></td></tr>
                <tr><td> <button type="submit" class="btn btn-info btn-user btn-block">
        Simpan Invoice
    </button></td></tr>
